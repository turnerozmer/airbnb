...
SELECT listings.property_type, count(*), MAX(reviews.date_reviewed) FROM listings INNER JOIN reviews ON listings.id = reviews.listing_id GROUP BY listings.property_type ORDER BY listings.property_type ASC;
